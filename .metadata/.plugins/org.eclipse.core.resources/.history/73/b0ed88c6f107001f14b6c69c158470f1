...
public class WavFile extends SampledFile {
		...
		public static long computeDuration(long numberOfFrames, float frameRate) {
			durationResult = (long) ((WavParamReader.getNumberOfFrames()/WavParamReader.getFrameRate())*1000000);
		...
		public static String timeFormatter(long timeInMicroSeconds) {
			...
			long durationInSeconds = wf.getDuration()/1000000;
			float durationInMinutesAndSeconds = durationInSeconds/60;
